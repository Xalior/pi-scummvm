...
// configuration file) and the cooperative scheduler. Video, USB input and
// audio belong to circle-libsdl2 and are created inside SDL_Init when
// ScummVM calls it. So do the CPU clock and the case fan, which the shim
