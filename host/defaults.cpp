...
//     scummvm-defaults.ld pins to image offset 0x800. It ships with the
...
#ifdef __ELF__
__asm__ (
    "\t.section .scummvm.entry, \"ax\", %progbits\n"
    "\t.globl _scummvm_entry\n"
    "_scummvm_entry:\n"
    "\tb _start\n"
    "\t.previous\n"
);
#define DEFAULTS_BLOCK_PLACEMENT \
    __attribute__ ((section (".scummvm.defaults"), used, aligned (8)))
#else
...
TDefaultsBlock _scummvm_defaults =
{
