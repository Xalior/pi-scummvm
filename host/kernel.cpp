...
TShutdownMode CKernel::Run(void)
{
    ...
    // the two --rapi-cache switches have had their say. Before the game
    // runs, so the allocations it ever makes happen while the heap is still
    // empty, and every read ScummVM makes meets a cache that is already
    // there.
